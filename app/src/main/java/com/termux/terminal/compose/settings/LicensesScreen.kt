...
@Composable
private fun licenses(): List<LicenseInfo> = listOf(
    LicenseInfo(
        name = stringResource(R.string.license_gplv3),
        detail = stringResource(R.string.license_terminal_project),
        url = "https://www.gnu.org/licenses/gpl-3.0.html"
    ),
    LicenseInfo(
        name = stringResource(R.string.license_apache2),
        detail = stringResource(R.string.license_termux_libraries),
        url = "https://www.apache.org/licenses/LICENSE-2.0"
    ),
    LicenseInfo(
        name = stringResource(R.string.license_mit),
        detail = stringResource(R.string.license_termux_constants),
